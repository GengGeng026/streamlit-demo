...
class NotionDataVisualizer:
    ...
    def save_config(self):
        if self.token and self.database_id:
            ...
            st.session_state.show_fadeout_message = True
...
if 'show_fadeout_message' not in st.session_state:
    st.session_state.show_fadeout_message = False
...
if st.session_state.config_saved:
    if st.session_state.show_fadeout_message:
